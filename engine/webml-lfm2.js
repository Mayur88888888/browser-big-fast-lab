// Vendored from Xenova / HF webml-community Space "lfm2-webgpu-kernels"
// (https://huggingface.co/spaces/webml-community/lfm2-webgpu-kernels), adapted in LocalMind
// (https://github.com/NakliTechie/LocalMind). Exports Lfm2Mobile. Re-hosted here with
// credit so the lane can run inline for comparison. All credit to the original authors.
// LFM2.5-230M (Q4_0 GGUF) WebGPU chat bundle. Import { Lfm2Mobile } from this file.
